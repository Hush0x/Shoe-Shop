export function generateFilter(name, target) {
    ...
    filterBtn.className = "w-fit px-5 h-10 flex items-center text-[#343A40] bg-white rounded-3xl border-2 border-[#343A40] font-semibold text-base m-2 whitespace-nowrap filter"
